...
import (
	...
	"github.com/FabioMeirelles3/codepix/application/factory"
	appmodel "github.com/FabioMeirelles3/codepix/application/model"
...
func (k *KafkaProcessor) processMessage(msg *ckafka.Message) {
	...
	transactionConfirmationsTopic := "transaction_confirmation"

	switch topic := *msg.TopicPartition.Topic; topic {
	case transactionsTopic:
		k.processTransaction(msg)
	case transactionConfirmationsTopic:
